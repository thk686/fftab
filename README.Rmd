...
rather than lists, vectors, and so on.
...
I intend to keep this package current and availabe on CRAN. If you would like to contribute of
code or maintenance, please create an issue on github.
